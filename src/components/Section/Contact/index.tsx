...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="flex flex-col items-center pb-8 pt-16">
      <div>
        <h2 className="text-4xl text-center font-bold mb-16">Contato</h2>
      </div>
      <div className="flex flex-col sm:flex-row sm:gap-20">
        ...
        <div className="px-6 pt-16 flex flex-col gap-8 overflow-hidden sm:pt-0 text-ellipsis">
          <a
            ...
            className="flex items-center hover:scale-105 cursor-pointer sm:p-2"
            rel="noreferrer"
          >
            <MdOutlineMail className="mr-2" />
            <h4 className="text-lg text-center font-bold">Email:&nbsp;</h4>
            <p className="text-sm">lucasdafonsecadepaula@gmail.com</p>
          </a>
          <a
            target="_blank"
          ...
          >
            ...
            <h4 className="text-lg text-center font-bold">Linkedin:&nbsp;</h4>
            <p className="text-sm">lucas da fonseca de paula</p>
          </a>
          <a
            target="_blank"
          ...
          >
            ...
            <h4 className="text-lg text-center font-bold">Whatsapp:&nbsp;</h4>
            <p className="text-sm">+55 32 99122-8037</p>
          </a>
          <a
            target="_blank"
          ...
          >
            ...
            <h4 className="text-lg text-center font-bold">Github:&nbsp;</h4>
            <p className="text-sm">lucasdafonsecadepaula</p>
          </a>
        </div>
      </div>
    </section>
