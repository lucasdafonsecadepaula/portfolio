      ...
      {cards.map((card, index) => {
        return (
          <motion.div
            key={card.id}
            onClick={flip}
            className="absolute bg-[#050505] h-60 w-60 md:h-60 md:w-96 rounded-3xl p-4 border border-neutral-200 shadow-black/[0.1] shadow-md flex flex-col justify-between"
            style={{
